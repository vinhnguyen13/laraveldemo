                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('building_name')) has-error @endif">
                            ...
                            {!! Form::text('building_name', '', ['class' => 'form-control', 'placeholder' => 'Building Name', 'id' => 'building_name']) !!}
                        ...
                        <div class="form-group @if($errors->has('building_name_en')) has-error @endif">
                            ...
                            {!! Form::text('building_name_en', '', ['class' => 'form-control', 'placeholder' => 'Building Name', 'id' => 'building_name_en']) !!}
                        ...
                        <div class="form-group @if($errors->has('address_en')) has-error @endif">
                            ...
                            {!! Form::text('address_en', '', ['class' => 'form-control', 'placeholder' => 'Address', 'id' => 'address_en']) !!}
                        ...
                        <div class="form-group @if($errors->has('fax')) has-error @endif">
                            ...
                            {!! Form::text('fax', '', ['class' => 'form-control', 'placeholder' => 'Fax', 'id' => 'fax']) !!}
                        ...
                        <div class="form-group @if($errors->has('hotline')) has-error @endif">
                            ...
                            {!! Form::text('hotline', '', ['class' => 'form-control', 'placeholder' => 'Hotline', 'id' => 'hotline']) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group @if($errors->has('gmap_url')) has-error @endif">
                            ...
                            {!! Form::text('gmap_url', '', ['class' => 'form-control', 'placeholder' => 'Google Map Url', 'id' => 'gmap_url']) !!}
