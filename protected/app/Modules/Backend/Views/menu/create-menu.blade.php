...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(['url' => Request::url() . $qs, 'name' => 'menuForm', 'id' => 'menuForm', 'role' => 'form', 'files' => true]) !!}
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-7">
                        ...
                        <div class="form-group @if($errors->has('title_en')) has-error @endif">
                            ...
                            {!! Form::text('title_en', '', ['class' => 'form-control', 'placeholder' => 'Title', 'id' => 'title_en']) !!}
                ...
                <div class="box-footer">
                    <div class="text-right">
                        ...
                        <a href="{{ url('admin/menu', [$cat_id]) . $qs }}" class="btn btn-danger btn-flat"><i class="fa fa-ban"></i> Cancel</a>
                    </div>
                </div>
            </div>
